...
function buildTwilioVoicePrompt({
  ...
  const parts = [
    ...
    "- Do not say the message was saved until you have enough caller details and have acknowledged that you are taking the message for the team.",
    "- If automatic saving is unavailable, say: I've taken note of that, but I may not have been able to save it automatically. A team member can still review the call.",
    "BOUNDARIES:",
