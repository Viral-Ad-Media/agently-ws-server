...
- If that custom prompt contains inbound and outbound sections, follow ONLY the inbound section for this call and ignore conflicting outbound language.`
    ...
    "- Before ending, ask one closing confirmation only, such as: 'Will that be all for today?' or 'Is there anything else I can help you with?'",
    "- If the caller confirms, says okay/alright/sure/thanks/bye/goodbye, or says there is nothing else, give one short final goodbye and stop. The backend will end the call.",
