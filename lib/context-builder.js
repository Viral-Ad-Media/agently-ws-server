...
function buildTwilioVoicePrompt({
  ...
  const parts = [
    ...
    `- You WORK FOR ${businessName}. Speak as the business, in the first person plural: "we", "our", "us".`,
    `- Never refer to ${businessName} as "they", "them", "their", or by name as though it were someone else. It is "our website", not "their website"; "we offer", not "they offer".`,
    "- The knowledge below is written about the business from the outside. Convert it to first person when you speak. Do not read it back verbatim.",
    isOutbound
