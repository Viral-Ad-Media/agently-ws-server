  ...
  openaiWs.on("open", () => {
    ...
    openaiWs.send(
      JSON.stringify({
        type: "session.update",
        session: {
          // REMOVED: type: "realtime" - deprecated in GA API
          modalities: ["audio", "text"],
          voice,
          instructions: systemPrompt,
          input_audio_format: "pcm16",
          output_audio_format: "pcm16",
          // Updated transcription configuration for GA API
          input_audio_transcription: {
            model: "whisper-1", // GA model name (April 2026)
          },
          turn_detection: {
            type: "server_vad",
            threshold: 0.5,
          ...
          temperature: 0.7, // Re-added - supported in GA API
