...
// GA Realtime API — model updated from preview to GA
...
async function handleRealtimeProxy(browserWs, req) {
  ...
  const openaiWs = new WebSocket(OPENAI_REALTIME_URL, {
    headers: {
      ...
      // NOTE: Do NOT include OpenAI-Beta: realtime=v1 here.
      // That header was required for the beta API but causes errors with GA.
    },
  });
    ...
    openaiWs.send(
      JSON.stringify({
        ...
        session: {
          ...
          // temperature removed — not supported in GA API
