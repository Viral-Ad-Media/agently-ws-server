    ...
    session: {
      ...
      audio: {
        input: {
          ...
          turn_detection: {
            type: "server_vad",
            // Matched to the web-call path. At 0.5/650 the assistant replied
            // to coughs and background noise, and treated an ordinary
            // mid-sentence pause as the end of a turn — so it interrupted.
            // A higher threshold needs a clearer voice before it starts
            // listening; a longer silence window lets people finish a thought.
            threshold: Number(process.env.REALTIME_VAD_THRESHOLD || 0.7),
            prefix_padding_ms: 300,
            silence_duration_ms: Number(
              process.env.REALTIME_VAD_SILENCE_MS || 900,
            ),
