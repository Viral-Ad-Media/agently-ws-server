...
function humanizeOutboundPurposeForSpeech(text, maxChars = 260) {
  const interpreted = interpretOutboundPurposeForSpeech(text);
  const cleaned = sanitizeOutboundPurposeText(interpreted || text, maxChars);
  return cleaned;
}
